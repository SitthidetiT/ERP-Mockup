...
export const initialData: AppData = {
  ...
  jobs: [
...

    {
      ...
      email: "contact@alpha.example",
      address: "88/1 ถนนตัวอย่าง แขวงอุตสาหกรรม เขตพัฒนา กรุงเทพฯ 10200",
      title: "ใบเสนอราคาเบื้องต้น",
      description: "กำลังทำใบเสนอราคา รอสรุปยอดวัสดุ",
      due: "2026-10-15",
      priority: "ปกติ",
      kind: "ทำเอง 100%",
      stage: 0,
      owner: "Sales",
      lines: [{ name: "สินค้าตัวอย่าง (รอคำนวณ)", qty: 10, price: 500 }],
      drawingVersion: 0,
      route: [],
      materialsIssued: false,
      outsourced: false,
    ...
    },
    {
      ...
      contact: "คุณพิม (ข้อมูลสมมติ)",
      email: "procurement@beta.example",
      title: "ชุดควบคุมระยะไกล",
      description: "เสนอราคาแล้ว รอการตัดสินใจจากลูกค้า",
      due: "2026-10-20",
      priority: "ปกติ",
      kind: "ทำเองบางส่วน / จ้างภายนอกบางส่วน",
      stage: 1,
      owner: "Sales",
      lines: [{ name: "ชุดตู้คอนโทรล", qty: 2, price: 45000 }],
      drawingVersion: 0,
      route: [],
      materialsIssued: false,
      outsourced: false,
    ...
    },
    {
      ...
      contact: "คุณนที (ข้อมูลสมมติ)",
      email: "orders@gamma.example",
      title: "อุปกรณ์เซ็นเซอร์ รุ่น S1",
      description: "ลูกค้าตอบรับกลับมาแล้ว รอดำเนินการเปิดงาน",
      due: "2026-10-10",
      priority: "สูง",
      kind: "ทำเอง 100%",
      stage: 2,
      owner: "Sales",
      lines: [{ name: "เซ็นเซอร์ รุ่น S1", qty: 50, price: 1200 }],
      drawingVersion: 0,
      route: [],
      materialsIssued: false,
      outsourced: false,
    ...
    },
    {
      ...
      contact: "คุณอร (ข้อมูลสมมติ)",
      email: "contact@alpha.example",
      title: "แท่นเจาะโลหะขนาดเล็ก",
      description: "วิศวกรตรวจสอบและอนุมัติแบบร่างแล้ว",
      due: "2026-10-25",
      priority: "ปกติ",
      kind: "ทำเอง 100%",
      stage: 4,
      owner: "ผู้เขียนแบบ",
      lines: [{ name: "แท่นเจาะขนาดเล็ก", qty: 5, price: 15000 }],
      drawingVersion: 1,
      route: [],
      materialsIssued: false,
      outsourced: false,
    ...
    },
    {
      ...
      contact: "คุณดา (ข้อมูลสมมติ)",
      email: "sample@delta.example",
      title: "ข้อต่อไฮดรอลิก 4 นิ้ว",
      description: "เขียนแบบเสร็จสิ้น พร้อมส่งเข้าไลน์ผลิต",
      due: "2026-11-01",
      priority: "ปกติ",
      kind: "ทำเอง 100%",
      stage: 5,
      owner: "PPC",
      lines: [{ name: "ข้อต่อไฮดรอลิก รุ่นใหญ่", qty: 100, price: 350 }],
      drawingVersion: 2,
      route: ["CNC Lathe"],
      materialsIssued: false,
      outsourced: false,
    ...
    },
    {
      ...
      contact: "คุณพิม (ข้อมูลสมมติ)",
      email: "procurement@beta.example",
      title: "ฝาครอบมอเตอร์อะลูมิเนียม",
      description: "เบิกวัสดุจากคลังเรียบร้อย รอฝ่ายผลิตมารับ",
      due: "2026-10-02",
      priority: "เร่งด่วน",
      kind: "ทำเอง 100%",
      stage: 7,
      owner: "ฝ่ายผลิต",
      lines: [{ name: "ฝาครอบอะลูมิเนียม", qty: 10, price: 800 }],
      drawingVersion: 1,
      route: ["CNC Milling"],
      materialsIssued: true,
      outsourced: false,
    ...
    },
    {
      ...
      contact: "คุณนที (ข้อมูลสมมติ)",
      email: "orders@gamma.example",
      title: "แผงวงจรควบคุมหลัก",
      description: "ผ่านการตรวจสอบ QC แล้ว",
      due: "2026-09-28",
      priority: "สูง",
      kind: "ทำเองบางส่วน / จ้างภายนอกบางส่วน",
      stage: 9,
      owner: "QC",
      lines: [{ name: "แผงวงจรควบคุม V1", qty: 20, price: 2500 }],
      drawingVersion: 1,
      route: ["Assembly"],
      materialsIssued: true,
      outsourced: true,
      outsourceSent: true,
      outsourceReturned: true,
      qcFailCount: 0,
      qcPass: 20,
      qcReject: 0,
      qcReason: "",
    ...
    },
    {
      ...
      contact: "คุณอร (ข้อมูลสมมติ)",
      email: "contact@alpha.example",
      title: "ตัวยึดเซ็นเซอร์ (หล่อผิดสเปก)",
      description: "งานไม่ได้คุณภาพ รอดำเนินการแก้ไขใหม่",
      due: "2026-09-27",
      priority: "เร่งด่วน",
      kind: "ทำเอง 100%",
      stage: 9,
      owner: "ฝ่ายผลิต",
      lines: [{ name: "ตัวยึดเซ็นเซอร์ 50mm", qty: 15, price: 400 }],
      drawingVersion: 1,
      route: ["Milling"],
      materialsIssued: true,
      outsourced: false,
      ...
      qcPass: 0,
      qcReject: 15,
      qcReason: "ขนาดรูกว้างเกินสเปก 0.5mm",
      rework: true,
      packed: false,
      delivered: false,
      logs: [],
    },
    {
      ...
      contact: "คุณดา (ข้อมูลสมมติ)",
      email: "sample@delta.example",
      title: "ชุดประกอบเครื่องพิมพ์ขนาดเล็ก",
      description: "บรรจุลงกล่องพร้อมเตรียมจัดส่ง",
      due: "2026-09-25",
      priority: "ปกติ",
      kind: "ทำเอง 100%",
      stage: 10,
      owner: "จัดส่ง",
      lines: [{ name: "ชุดเครื่องพิมพ์ V3", qty: 2, price: 32000 }],
      drawingVersion: 2,
      route: ["Assembly"],
      materialsIssued: true,
      outsourced: false,
    ...
    },
    {
      ...
      contact: "คุณพิม (ข้อมูลสมมติ)",
      email: "procurement@beta.example",
      title: "ล้อและลูกปืนอุตสาหกรรม",
      description: "จัดส่งและลูกค้ารับสินค้าเรียบร้อย",
      due: "2026-09-20",
      priority: "ปกติ",
      kind: "ทำเอง 100%",
      stage: 11,
      owner: "ผู้บริหาร",
      lines: [{ name: "ล้ออุตสาหกรรม 8 นิ้ว", qty: 40, price: 550 }],
      drawingVersion: 1,
      route: ["Lathe", "Assembly"],
      materialsIssued: true,
      outsourced: false,
      outsourceSent: false,
      outsourceReturned: false,
